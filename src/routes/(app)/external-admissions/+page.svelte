...
<main class="flex flex-col gap-4 py-4 mx-auto">
	...
	{#each data.externalAdmissions as admission, caseIndex}
		<div class="w-full shadow-xl daisy-card bg-base-100">
			<div class="daisy-card-body">
				...
				>
					<button
						...
						on:click={async () => await copyFormatterdCase(caseIndex)}>Copiar caso formatado</button
					>
					<a href="/external-admissions/{admission._id}" class="w-28 daisy-btn daisy-btn-secondary"
						>Editar internação</a
					>
					{#if admission.discharged}
